...
% Last Modified by GUIDE v2.5 27-May-2022 21:44:03
...
set(handles.text10,'string',jumlah);
if (jumlah < 0.62)
    set (handles.text11, 'string', 'pepaya terbelah');
end
if (jumlah >= 0.62)
    set (handles.text11, 'string', 'pepaya utuh');
end;

set (handles.text12, 'string', num2str(Contrast(1)));
set (handles.text13, 'string', num2str(Correlation(1)));
set (handles.text14, 'string', num2str(Energy(1)));
set (handles.text15, 'string', num2str(Homogeneity(1)));
